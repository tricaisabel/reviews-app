...
import { createCompany, getAllCompanies, getCompanyById, validateNewCompany } from '../controllers/company.controller';
...
companyRouter.get('/:companyId', async (req: Request, res: Response): Promise<void> => {
    try {
...
companyRouter.post('/', upload.single("file"), async(req: Request, res:Response)=>{
    try{
